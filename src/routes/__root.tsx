...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CONNECT Training Solutions offers comprehensive placement training, aptitude, and interview preparation programs designed to equip students with industry" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "CONNECT Training Solutions | Training & Placement Experts" },
      { property: "og:description", content: "CONNECT Training Solutions offers comprehensive placement training, aptitude, and interview preparation programs designed to equip students with industry" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CONNECT Training Solutions | Training & Placement Experts" },
      { name: "twitter:description", content: "CONNECT Training Solutions offers comprehensive placement training, aptitude, and interview preparation programs designed to equip students with industry" },
